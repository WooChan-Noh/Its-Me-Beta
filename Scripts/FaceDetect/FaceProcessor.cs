namespace OpenCvSharp.Demo
{
        ...
        where T: UnityEngine.Texture
    {
        ...
        public int squareSizeMin = 100;//얼굴의 red box의 크기가 곧 카메라와의 거리를 의미한다.
        public int squareSizeMax = 200;//무조건 정사각형임
        ...
        where T : UnityEngine.Texture
    {
        ...
        public float takePhotoTime = 3.5f;//이 시간동안 face가 측정되면 사진 촬영
        public float timeControl = 18.0f;//이 스크립트에서 측정되는 deltaTime이 너무 작아서 사용중 ->  곱해주지 않으면 3초보다 더걸림
